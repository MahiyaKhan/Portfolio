          ...
          <div className="contact__info" data-aos="fade-up">
            ...
            <div className="contact__info-details">
              <ul>
                <li>
                  ...
                  <p>
                    <span>Address:&nbsp;&nbsp;</span>Aligarh, Uttar Pradesh,
                    India
                  </p>
                </li>
                <li>
                ...
                <li>
                  ...
                  <p>
                    <span>Email:&nbsp;&nbsp;</span>mohdaquib31@gmail.com
                  </p>
                </li>
                <li>
                  {" "}
                  <FontAwesomeIcon icon={faSquareCheck} size="2x" />
                  <span>Data Scientist at Extreme Networks</span>
                </li>
              </ul>
            </div>
            <div className="contact__social">
              <p className="contact__linkedin">
                <a
                  href="https://www.linkedin.com/in/aquibpy/"
