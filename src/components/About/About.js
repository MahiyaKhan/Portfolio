          ...
          <div className="about__details-container">
            ...
            >
              <Link to="/about/intro">
                ...
                <p>
                  I am <span>Mohd Aquib.</span> <br /> Highly passoinate Data
                  Scientist with more than 2 years of experience.
                </p>
              </Link>
            </div>
            <div
            ...
            >
              <Link to="/about/experience">
                ...
                <p>
                  ...
                  <br />I specialize in transforming data into actionable
                  insights, utilizing advanced tools like TensorFlow and PyTorch
            ...
            >
              <Link to="/about/internships">
                ...
                <ul>
                  <li>
                    <span>Wobot Intelligence</span> - Computer Vision Intern{" "}
                  </li>
                </ul>
              </Link>
            </div>
            ...
            >
              <Link to="/about/graduation">
                ...
                <p>
                  ...
                  <br />
                  Master's in Computer Science and Applications (2019 - 2022),
                  preceded by a B.Sc (Hons) in Computer Science (2016 - 2019).
                </p>
              </Link>
            </div>
          </div>
